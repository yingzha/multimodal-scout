...
echo ""
echo "Next steps:"
echo "1. Update PROJECT_ID and REGION in YAML files"
echo "2. Build and push images: ./build-and-deploy.sh $PROJECT_ID $REGION"
echo "3. Deploy services: ./deploy-services.sh $PROJECT_ID $REGION"
echo ""
